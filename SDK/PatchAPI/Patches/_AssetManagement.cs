    ...
    public static class _AssetManagement
    {
        ...
        public static void InitObjectInstantiatedPatch()
        {
            try
            {
                ...
                SDK.LogHandler.Log(SDK.LogHandler.Colors.Green, "[Patch] AssetManagement", false, false);
            }
            catch
            {
                SDK.LogHandler.Log(SDK.LogHandler.Colors.Red, "[Patch] [Error] AssetManagement", false, false);
            }
        }
